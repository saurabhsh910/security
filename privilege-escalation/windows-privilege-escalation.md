...
### Basic Enumeration of the System <a id="basic-enumeration-of-the-system"></a>
...
### Cleartext Passwords <a id="cleartext-passwords"></a>

#### Search for them <a id="search-for-them"></a>
...
#### In Registry <a id="in-registry"></a>
...
### Scheduled Tasks <a id="scheduled-tasks"></a>
...
### Change the upnp service binary <a id="change-the-upnp-service-binary"></a>
...
### Weak Service Permissions <a id="weak-service-permissions"></a>
...
### Unquoted Service Paths <a id="unquoted-service-paths"></a>
...
### Escalate to SYSTEM from Administrator <a id="escalate-to-system-from-administrator"></a>

#### On Windows XP and Older <a id="on-windows-xp-and-older"></a>
...
#### Vista and Newer <a id="vista-and-newer"></a>
...
#### Using Metasploit <a id="using-metasploit"></a>
